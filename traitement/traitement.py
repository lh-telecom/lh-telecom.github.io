...
directory = 'new_articles'
#liste des articles avec les liens pour y accéder
articles = [ (a.split(".")[0]+".html", a.split(".")[0]) for a in os.listdir(directory) ]
...
# genere le html dans "dist"
with open("../templates/LH1/articles/home.html", "w",encoding='utf-8') as file:
    file.write(html)