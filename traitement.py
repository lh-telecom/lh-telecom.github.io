        ...
        with tag("div", klass="grille_page"):
            with tag("div", klass="corps_de_page grille_body"):
                with tag("h1"):
                    text(TITRE)
                with tag("div", klass="mot_de_la_redaction"):
                    doc.asis(markdown(str("<p>Le contenu que vous recherchez n'existe pas! <small>(encore)</small> <br></p><p><a href=\"/\">Revenir à la page d'accueil</a></p><p>Normalement ça devrait pas super bien marcher</p>")))

html = doc.getvalue()

# genere le html dans "dist"
with open("static/404.html", "w",encoding='utf-8') as file:
    file.write(html)
